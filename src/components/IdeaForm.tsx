...
export function IdeaForm({ onSuccess, editingIdea, onCancel }: IdeaFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-gradient-to-br from-card to-card/50 backdrop-blur-sm p-6 sm:p-8 rounded-2xl shadow-xl border border-border/50 space-y-5">
      {editingIdea && (
